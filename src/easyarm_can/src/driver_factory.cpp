  ...
  bool is_canfd)
{
  switch (vendor) {
    case Vendor::Jxservo:
      return std::make_unique<JxservoDriver>(transport, host_can_id, is_canfd);
    case Vendor::Ti5robot:
      return std::make_unique<Ti5robotDriver>(transport, host_can_id, is_canfd);
    case Vendor::Xhumanoid:
      return std::make_unique<XhumanoidDriver>(transport, host_can_id, is_canfd);
    case Vendor::Unknown:
      break;
  }
  return nullptr;
