/**
 * @file jxservo_can_driver.hpp
 * @brief 巨蟹智能电机 CAN 通信驱动骨架
 *
 * 一个驱动实例管理一个 SocketCAN 接口、一个接收线程和按 motor_id 索引的反馈缓存。
 */

#ifndef JXSERVO_CAN__JXSERVO_CAN_DRIVER_HPP_
#define JXSERVO_CAN__JXSERVO_CAN_DRIVER_HPP_
...
public:
   ...
   */
  explicit JxservoCanDriver(const std::string & can_interface, uint8_t host_can_id = 0x00);
...
#endif  // JXSERVO_CAN__JXSERVO_CAN_DRIVER_HPP_
